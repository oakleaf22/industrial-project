...
\hlc[pink]{The PCMs, developed and manufactured by Sunamp, are non-toxic, non-flammable, eco-friendly, ethically sourced} and patented in the UK and China, with patents pending in other countries \citep{SunampAutomotive}.
...
\begin{figure}[htbp]
	...
	\end{subfigure}
	\rule{\textwidth}{0.5pt} % use line???
	\caption{\hlc[pink]{Cross-sections of Sunamp's UniQ batteries.}}
...
The week started with an induction from \hlc[pink]{Susan Lang-Bissell, the Chief Operation Officer (COO)}, where we went over my contract, office information, health and safety regulations (amongst other things) and I got a brief tour of the factory.
...
\begin{itemize}
    ...
    \item \hlc[pink]{Different PCM mixtures can react differently to aluminium and copper, the main metals that heat exchangers are built from. Sunamp typically uses all-aluminium finned-tube heat exchangers because aluminium is much cheaper than copper} \citep{Sommers2010}, \hlc[pink]{but they will sometimes create a PCM which corrodes aluminium. In these cases they might need to consider using copper-based heat exchangers, which might work out cheaper in the long-run when compared to the capital and operational costs of the heat batteries' equivalent hot water cylinders. Sunamp's chemists carry out extensive tests of PCM reactions with these metals to ensure full compatibility of the materials in the end-product.}
...
During my fifth week at Sunamp, I took part in a meeting with Susan (COO), Joan, \hlc[pink]{Susan Dinwoodie (Executive Personal Assistant), and Maggie Wright (Maggie Wright Associates, a Public Relations company)}
...
\hlc[pink]{For this, they have produced mock-ups of my PISs (see a couple examples in} Appendix~\ref{App:mockups}).
