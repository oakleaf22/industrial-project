...
Sunamp designs and produces super-compact heat batteries which store available energy as heat and release it when it is required, thus overcoming the intermittent nature of many other renewable energy sources. The technology is based on phase change materials (PCMs) to provide a clean, efficient and cost-effective heat energy storage solution.
...
The PCMs, developed and manufactured by Sunamp, are non-toxic, non-flammable, eco-friendly, ethically sourced and patented in the UK and China, with patents pending in other countries \citep{SunampAutomotive}.
...
\begin{figure}[htbp]
	...
	\caption[The temperature range of Sunamp's PCMs.]{The temperature range of Sunamp's PCMs in degrees Celsius \citep{SunampAutomotive}.}
	\label{pcm_temp_range}
\end{figure}


Sunamp was founded by Andrew Bissell, who is the chief executive officer (CEO).
In Macmerry, East Lothian, they have an office building which features a research and development (R\&D) workshop and materials laboratory on the ground floor and an open-plan office on the first floor. They also have a factory across the road where they have additional test facilities but primarily do large-scale manufacturing of heat batteries. Sunamp employs 32 people: 22 office-based, six in the factory, three based on the road and one based in Zurich, where Sunamp has a small satellite office.
...
\begin{wrapfigure}{r}{0.3\textwidth}
	...
	\caption[A crystallising hand warmer.]{A crystallising hand warmer \citep{FullyCharged}.}
...
\begin{figure}[htbp]
	...
	\end{subfigure}
	\rule{\textwidth}{0.5pt} % use line???
	\caption[Sunamp's UniQ heat battery range and nominal heat storage capacities in kWh.]{Sunamp's UniQ heat battery range and nominal heat storage capacities in kWh \citep{SunampHomepage}.}
...
\begin{wrapfigure}{r}{0.4\textwidth}
	...
	\caption[Typical energy consumption of a UK home.]{Typical energy consumption of a UK home \citep{SunampResidential}.}
...
The week started with an induction from Susan Lang-Bissell, the Chief Operation Officer (COO), where we went over my contract, office information, health and safety (H{\&}S) regulations (amongst other things) and I got a brief tour of the factory.
...
\begin{itemize}
    ...
    \item Different PCM mixtures can react differently to aluminium and copper, the main metals that heat exchangers are built from. Sunamp typically uses all-aluminium finned-tube heat exchangers because aluminium is much cheaper than copper \citep{Sommers2010}, but they will sometimes create a PCM which corrodes aluminium. In these cases they might need to consider using copper-based heat exchangers, which might work out cheaper in the long-run when compared to the capital and operational costs of the heat batteries' equivalent hot water cylinders. Sunamp's chemists carry out extensive tests of PCM reactions with these metals to ensure full compatibility of the materials in the end-product.
...
I contacted Joan and Susan (COO) in November 2018 and received an update on how I have contributed to Sunamp.
...
For this, they have produced mock-ups of my PISs (see a couple examples in Appendix~\ref{App:mockups}).
