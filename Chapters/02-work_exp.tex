...
Latent heat is the thermal energy required to change the phase of a substance (e.g. from a solid to a liquid, or a liquid to a gas) without it changing temperature.
...
\begin{figure}[htbp]
	...
	\end{subfigure}
	\rule{\textwidth}{0.5pt} % use line???
	\caption{Sunamp's UniQ heat battery range \hl{cite Sunamp's website}.
	%\citep{SunampHomepage}
	}
