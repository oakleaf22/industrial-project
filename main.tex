...
% This is a green filled circle \master ;\\
\newcommand{\master}{\raisebox{0pt}{\tikz{\node[draw,scale=0.8,circle,fill=black!20!green](){};}}}

% This is a yellow triangle \nomaster ;\\
\newcommand{\nomaster}{\raisebox{0.5pt}{\tikz{\node[draw,scale=0.5,regular polygon, regular polygon sides=3,fill=black!10!yellow,rotate=0](){};}}}

% This is a red diamond \littlemaster ;\\
\newcommand{\littlemaster}{\raisebox{0pt}{\tikz{\node[draw,scale=0.6,diamond,fill=black!10!red](){};}}}
...
\input{Front_Matter/04-Abbreviations.tex}
...
\input{Chapters/02-work_exp.tex}
\input{Chapters/03-skills_analysis.tex}
\input{Chapters/04-personal_reflection.tex}
...
\input{Appendices/App_Log}
\input{Appendices/App_Overview}
\input{Appendices/App_Quiz}
\input{Appendices/App_PISs}
\input{Appendices/App_PISmockups}
\input{Appendices/App_InO}
\input{Appendices/App_Presentation}
\input{Appendices/App_ECLOs}
%\input{Appendices/App_HWgrad}
\input{Appendices/App_matrix}
